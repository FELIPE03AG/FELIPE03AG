...
<body>
    ...
    <h2>Eliminar Cerdos por Venta</h2>
    ...
    <form action="eliminar_cerdos.php" method="POST">
        ...
        <input type="hidden" name="num_caseta_venta" value="<?php echo htmlspecialchars($id_caseta); ?>"> <!-- valor dinámico -->
        ...
        <div class="form-group">
            ...
            <input type="number" name="num_corral_venta" id="num_corral_venta" required>
        </div>
        <div class="form-group">
        ...
        <button type="submit">Eliminar por Venta</button>
    </form>
</div>
